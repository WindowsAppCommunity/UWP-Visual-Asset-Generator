...
using UWP_Visual_Asset_Generator.Views;
...
namespace UWP_Visual_Asset_Generator
{
    ...
    sealed partial class App : Application
    {
        ...
        public static TimeSpan ThinkingTiyPauseInMs = new TimeSpan(0, 0, 0, 0, 100); //10% of a second
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (rootFrame == null)
            {
                ...
                rootFrame.ContentTransitions.Add(new EntranceThemeTransition());
            ...
            {
                //Visual settinng not working (old version?)
            }
